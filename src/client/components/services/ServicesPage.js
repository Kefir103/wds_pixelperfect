    ...
    return (
        <div className={'services'}>
            <div className={'services__info'}>
                <div className={'content__text-heading'}>Our services</div>
                <hr />
                <div className={'content__text-desc'}>
                    Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac
                    turpis egestas. Maecenas euismod tellus nec tellus dictum malesuada. Cras vel
                    condirnenum justo. Nulla ullamcorper velit et ornare vehicula.
                </div>
            </div>
            <div className={'services__grid'}>
                ...
                <div className={'services__element'}>
                    ...
                    <div className={'services__element-info'}>
                        ...
                        <p className={'services__description'}>
                            Vestibulum vel lectus sapien. Fusce non fringilla lacus, ut congue arcu.
                ...
                <div className={'services__element'}>
                    ...
                    <div className={'services__element-info'}>
                        ...
                        <p className={'services__description'}>
                            Cras vel condimentum justo. Nulla ullamcorper velit et ornare vehicula.
                            Fusce egestas felis velit, non porttitor sapien hendrerit quis. Proin
                            tempor dui elit, nec faucibus arcu.
                        </p>
                        <p className={'services__learn-more'}>Learn more</p>
                    </div>
                </div>
                <div className={'services__element'}>
                    ...
                    <div className={'services__element-info'}>
                        ...
                        <p className={'services__description'}>
                            In eget lacus non mauris rutrum posuere at non est. Duis luctus sagittis
                            ullamcorper. Quisque rhoncus pharetra lobortis. Proin lacinia ligula a
                            risus porttitor aliquam non sit amet risus.
                        </p>
                        <p className={'services__learn-more'}>Learn more</p>
                    </div>
                </div>
                <div className={'services__element'}>
                    ...
                    <div className={'services__element-info'}>
                        ...
                        <p className={'services__description'}>
                            Maecenas condimentum lorem porttitor nisi suscipit tristique. Vivamus
                            cursus vestibulum mi. Phasellus posuere nulla quis nunc aliquam varius.
                            Integer dictum nisl id mauris.
                        </p>
                        <p className={'services__learn-more'}>Learn more</p>
                    </div>
                </div>
                <div className={'services__element'}>
                    ...
                    <div className={'services__element-info'}>
                        ...
                        <p className={'services__description'}>
                            Suspendisse laoreet, eros in euismod euismod, nunc turpis lacinia est,
                            eget malesuada sem felis eu dolor. Phasellus imperdiet eros sed
                            fermentum euismod.
                        </p>
                        <p className={'services__learn-more'}>Learn more</p>
                    </div>
                ...
                <div className={'services__element'}>
                    ...
                    <div className={'services__element-info'}>
                        ...
                        <p className={'services__description'}>
                            Vivamus non erat eu leo semper vulputate quis vel nibh. Aenean sodales
                            ullamcorper lorem, sed posuere nibh pulvinar id. Phasellus eu velit id
                            odio laoreet adipiscing eu vitae odio.
                        </p>
                        <p className={'services__learn-more'}>Learn more</p>
                    </div>
                </div>
